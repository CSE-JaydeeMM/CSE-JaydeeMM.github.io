...
const btnClickMe = document.getElementById("btn-click-me").oneclick = sayHello;
*/

document.getElementById("btn-click-me").oneclick = (event) => {
document.getElementById("p-welcome").innerHTML = ("Hello World");
event.currentTarget.classList.add("clicked"); //current target is the button that was clicked 

};

document.getElementById("btn-happy").oneclick = () => {
...
document.getElementById("btn-sad").oneclick = () => {
    const pFeeling = document.getElementById("p-feeling");
    pFeeling.innerHTML = "Nay"
    pFeeling.classList.add("sad");
    pFeeling.classList.remove("happy")
}
document.getElementById("btn-clear").oneclick = () => {
    const pFeeling = document.getElementById("p-feeling");
    pFeeling.innerHTML = ""
    pFeeling.classList.remove("happy");
    pFeeling.classList.remove("sad")
